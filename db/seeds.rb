...
Item.create!(name: "Sedia a Rotelle Elettrica", description: description, user_id: user , price_cents: price, category: "Health", location: location).photo.attach(io: URI.open('https://i.ebayimg.com/images/g/1wwAAOSwLmtfA71p/s-l400.jpg'), filename: 'surf.png', content_type: 'image/png')
Item.create!(name: "Zaino Montagna Invernale", description: description, user_id: user , price_cents: price, category: "Sport & outdoors", location: location).photo.attach(io: URI.open('https://source.unsplash.com/-Q_BTq5J93w/600x400'), filename: 'zaino.png', content_type: 'image/png')
Item.create!(name: "Zaino Montagna Estivo", description: description, user_id: user , price_cents: price, category: "Sport & outdoors", location: location).photo.attach(io: URI.open('https://source.unsplash.com/8sjBzL1IyMo/600x400'), filename: 'zaino2.png', content_type: 'image/png')
...
Item.create!(name: "Passeggino", description: description, user_id: user , price_cents: price, category: "Baby", location: location).photo.attach(io: URI.open('https://source.unsplash.com/iESIEEShXuk/600x400'), filename: 'pass.png', content_type: 'image/png')
Item.create!(name: "Borsa YSL", description: description, user_id: user , price_cents: price, category: "Women’s fashion", location: location).photo.attach(io: URI.open('https://source.unsplash.com/2B-zwo_nq7k/600x400'), filename: 'borsa.png', content_type: 'image/png')
Item.create!(name: "Valigia Rigida", description: description, user_id: user , price_cents: price, category: "Luggage", location: location).photo.attach(io: URI.open('https://source.unsplash.com/g8zCEU8UNVI/600x400'), filename: 'valigia.png', content_type: 'image/png')
Item.create!(name: "Trolley Alluminio", description: description, user_id: user , price_cents: price, category: "Luggage", location: location).photo.attach(io: URI.open('https://source.unsplash.com/Pll7gOlLTpQ/600x400'), filename: 'valigia2.png', content_type: 'image/png')
Item.create!(name: "Bidi da Corsa", description: description, user_id: user , price_cents: price, category: "Sport & outdoors", location: location).photo.attach(io: URI.open('https://source.unsplash.com/0ClfreiNppM/600x400'), filename: 'Bici.png', content_type: 'image/png')
...
Item.create!(name: "Canoa 2 posti", description: description, user_id: user , price_cents: price, category: "Sport & outdoors", location: location).photo.attach(io: URI.open('https://source.unsplash.com/6z5O9gIzn7Y/600x400'), filename: 'canoa.png', content_type: 'image/png')
Item.create!(name: "Racchetta Tennis Pro", description: description, user_id: user , price_cents: price, category: "Sport & outdoors", location: location).photo.attach(io: URI.open('https://source.unsplash.com/OH5g9IgcMWs/600x400'), filename: 'tennis.png', content_type: 'image/png')
...
Item.create!(name: "Custodia Sub Canon", description: description, user_id: user , price_cents: price, category: "Electronics", location: location).photo.attach(io: URI.open('https://source.unsplash.com/x7yF73Sq3fE/600x400'), filename: 'camera1.png', content_type: 'image/png')
...
Item.create!(name: "Microfono Studio", description: description, user_id: user , price_cents: price, category: "Music", location: location).photo.attach(io: URI.open('https://source.unsplash.com/r-QvLCLakkA/600x400'), filename: 'mic.png', content_type: 'image/png')
...
Item.create!(name: "Chitarra Fender", description: description, user_id: user , price_cents: price, category: "Music", location: location).photo.attach(io: URI.open('https://source.unsplash.com/uszCr5AW1jA/600x400'), filename: 'chitarra1.png', content_type: 'image/png')
Item.create!(name: "Amplificatore Fender", description: description, user_id: user , price_cents: price, category: "Music", location: location).photo.attach(io: URI.open('https://source.unsplash.com/MfLGvcy9ooY/600x400'), filename: 'chitarra3.png', content_type: 'image/png')
Item.create!(name: "Chitarra Jackson", description: description, user_id: user , price_cents: price, category: "Music", location: location).photo.attach(io: URI.open('https://source.unsplash.com/6WOtQjsxlpU/600x400'), filename: 'chitarra2.png', content_type: 'image/png')
Item.create!(name: "Batteria Elettrica", description: description, user_id: user , price_cents: price, category: "Music", location: location).photo.attach(io: URI.open('https://source.unsplash.com/3InmHADj6KE/600x400'), filename: 'batteria.png', content_type: 'image/png')
